...
angular
  ...
  .controller("ExpensesListCtrl", function(
    $scope,
    $filter,
    $rootScope,
    $stateParams,
      ...
      .then(function(data) {
        ...
        _.each($scope.data, function(element) {
          ...
          if (element.relationships.reimbursementFor.data !== null) {
            const url =
              "https://api.tnyu.org/v3/reimbursement-requests/" +
              element.relationships.reimbursementFor.data.id;
            $scope.reimbursing[element.id] =
              "<a href=" + url + ">" + url + "</a>";
          }
        });
      });
